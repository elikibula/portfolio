...
class About(models.Model):
    ...
    description3 = models.TextField(blank=False, null=True)
    description4 = models.TextField(blank=False, null=True)
    description5 = models.TextField(blank=False, null=True)
    description6 = models.TextField(blank=False, null=True)
    description7 = models.TextField(blank=False, null=True)
